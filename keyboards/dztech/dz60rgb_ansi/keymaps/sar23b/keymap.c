...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_60_ansi(
		...
		SFT_T(KC_LPRN), KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,  KC_N,  KC_M,   KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_RPRN),
	...
	[1] = LAYOUT_60_ansi(
		...
		KC_MPLY, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP, KC_PGDN, _______,
