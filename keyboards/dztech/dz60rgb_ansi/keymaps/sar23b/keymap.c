...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_60_ansi(
		...
		KC_MPLY, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP, KC_PGDN, KC_MPLY,
		_______, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, _______, _______, _______, KC_INS,  KC_DEL,  KC_MPLY,
		_______, _______, _______, _______, KC_MPLY, _______, KC_MPLY, _______
		),
	[2] = LAYOUT_60_ansi(
		...
		XXXXXXX, XXXXXXX, XXXXXXX, NK_TOGG, XXXXXXX,  XXXXXXX,  XXXXXXX, RESET),
	[3] = LAYOUT_60_ansi(
