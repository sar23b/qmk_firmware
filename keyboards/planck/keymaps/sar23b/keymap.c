...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TAB,  KC_QUOT, KC_LBRC, KC_RBRC, KC_EQL,  KC_UNDS, XXXXXXX, KC_DEL,  KC_HOME, KC_PGUP, XXXXXXX, KC_PSCR,
    _______, KC_BSLS, KC_PIPE, KC_TILD, KC_MINS, XXXXXXX, XXXXXXX, KC_INS,  KC_END,  KC_PGDN, XXXXXXX, _______,
    XXXXXXX, XXXXXXX, KC_GRV,  XXXXXXX, _______, XXXXXXX,          MO(3),   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    KC_LALT, KC_BRID, KC_BRIU, KC_LGUI, MO(3),   XXXXXXX,          _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
